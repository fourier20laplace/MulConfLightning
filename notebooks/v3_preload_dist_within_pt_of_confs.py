...
def process_subdir(subdir):
    ...
    for pdb in pdb_files:
        ...
        # 每对氨基酸之间的单位方向向量
        # 计算每对氨基酸之间的差向量
        pos_diff = confG.node_position.unsqueeze(0) - confG.node_position.unsqueeze(1)
    ...
    torch.save(mask_roi, os.path.join(gather_dir, "mask_roi.pt"))
    torch.save(roi_tensor, os.path.join(gather_dir, "roi_tensor.pt"))
