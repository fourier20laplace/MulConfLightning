...
def process_subdir(subdir):
    ...
    dist_within_pt=torch.cdist(refG.node_position,refG.node_position)
    dist_list = [dist_within_pt]*5
    ...
    residue_type=F.one_hot(refG.residue_type,num_classes=21)
    ...
    torch.save(fin_tensor, os.path.join(gather_dir, "rand_repr_within_pt_tensor.pt"))
