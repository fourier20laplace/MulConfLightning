    ...
    def __call__(self, data_list):
        ...
        for data in data_list:
            data_padded = {
                ...
                for k, v in data.items() if k in ('wt', 'mut', 'ddG', 'mutation_mask', 'index_info', 'mutation', 'expand_data_info', 'wtG', 'mtG')
            }
            ...
            if "wtDict" in data:
                data_padded["wtDict"] = data["wtDict"]
                data_padded["mtDict"] = data["mtDict"]
